...
processed (project_name substituted) are listed by name and extension:
    ...
    > mkdir ifxtest
    > cd ifxtest
    > django-admin startproject --template=https://github.com/harvardinformatics/ifxdjango/archive/v1.1.1.zip -e py,html,js,conf,ini,vue -n .env.development,.env.production,Dockerfile-drf,docker-compose.yml,Makefile ifxtest .
